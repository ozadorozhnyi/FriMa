...
class CreateDomainAreaTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('blocks', function (Blueprint $table) {
            ...
            $table->unsignedFloat('current_rent_price');
            $table->timestamps();
        ...
        Schema::create('bookings', function (Blueprint $table) {
            ...
            $table->enum('status', ['rejected', 'new', 'progress', 'archived']);
            $table->unsignedFloat('total_costs_on_date');
            $table->timestamps();
        ...
        Schema::create('busy_blocks', function (Blueprint $table) {
            ...
            $table->unsignedFloat('price_on_book_date');
            $table->timestamps();
